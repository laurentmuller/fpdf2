...
enum PdfBlendMode: string
{
    ...
    case DARKEN = 'Darken';
    /**
     * The darker color of the background content color and the annotation color is subtracted from
     * the lighter color.
     */
    ...
    case SCREEN = 'Screen';
    /**
     * Darkening or lightening of colors is based on the background content color. The effect is similar
     * to that of shin.
     */
